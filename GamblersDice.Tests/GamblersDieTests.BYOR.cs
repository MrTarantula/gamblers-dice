...
namespace GamblersDice.Tests
{
    ...
    public class GamblersDieTestsBYOR
    {
        ...
        {
            Assert.IsType<GamblersDie>(new GamblersDie(_rnd));
        }
        ...
        {
            Assert.IsType<GamblersDie>(new GamblersDie(_rnd, 6));
        }
        ...
        {
            Assert.IsType<GamblersDie>(new GamblersDie(_rnd, 1, 2, 3, 4, 5, 6));
        }
        ...
        {
            Assert.IsType<GamblersDie>(new GamblersDie(_rnd, new int[] { 1, 2, 3, 4, 5, 6 }));
        }
        ...
        {
            var die = new GamblersDie(_rnd, weights);
